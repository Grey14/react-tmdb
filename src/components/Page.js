  ...
  return (
    <div className="Page">
      ...
      <div className="Page-Button">
        {
          movie.page === 1 ? "" : <Link className='btn btn-default pull-left' to={`/moive/${previousPage}`}>Previous</Link>
        }
        {' '}
        {
          movie.page === 1000 ? "" : <Link className='btn btn-default pull-right' to={`/moive/${nextPage}`}>Next</Link>
        }
